...
> ACHTUNG  
> Da Yahoo die Lieferung von Daten für verschiedene Indizes (UK (FTSE), Italien (FTSE MIB), Singapur STI, Russland) eingestellt hat, 
> ist vorübergehend nur eine reduzierte Historie verfügbar.
> Zudem wird Singapur nicht berücksichtigt; für Italien und UK werden ETFs als Ersatz verwendet.  
...
Brasil       | IBOVESPA
France       | CAC-40
UK           | Continuous LIFFE Future auf FTSE
Italy        | Lyxor ETF auf FTSE MIB
Germany      | DAX
