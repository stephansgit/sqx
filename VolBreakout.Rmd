...
- Datenbasis ist nun das zur Verfügung gestellte Spreadsheet. Dabei werden die Kürzel von den angegebenen Börsen gezogen. Fúr die Werte, für die keine Daten von Yahoo geliefert wurden, wird eine zweite Datenabfrage an der Frankfurter Börse durchgeführt.  
...
#sheet <- register_ss("20150425_Ticker")
#ticker <- get_via_csv(ss=sheet, ws="ticker_werner")

ticker <- read.csv(file="ticker_werner.csv")
#ticker <- ticker[1:100,]
