...
> NEWS 18. April 2015:  
> Titel sind erweitert um Titel des MDAX, SDAX ud TecDax; somit werden ca. 160 deutsche Aktien überprüft.  
> Die Aktien, bei denen Auffälligkeiten gefunden werden, werden geplottet.  
...
for (i in 1:length(info)) {
  chartSeries(get(info[i], envir=stocks), subset='last 3 months', name=info[i]) 
}
```
.  
.  
