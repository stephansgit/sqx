...
> **NEWS 15.03.2015**:  
> Italienische Werte werden nun von Quandl bezogen. Somit sollte der Wert für Italien aktuell sein.
>
> **NEWS 13.03.2015**:  
> csv-Dateien mit Rohdaten werden exportiert: Links stehen unten im "Anhang".  
> Die aktuellen Einzelwert werden nun auch als Tabelle ausgegeben (siehe Bereich "Karte").  
>   
> **NEWS 12.03.2015**:  
> Update: Russische Daten werden nun ergänzt um Daten der Moskauer Börse, um Datenlücken bei Yahoo zu füllen.
> Für Italien noch keine Lösung gefunden - hier fehlen die letzten Daten i.d.R. und wurden mit dem letzten verfügbaren Wert fortgeschrieben.
...
Die letzten fünf **bereinigten** Einträge der Indexdaten. Fehlende Werte werden dabei zwischen letztem und nächstem verfügbaren Wert linear interpoliert. Fehlen Werte am Ende, wird der letzte verfügbare Wert fortgeschrieben.  
